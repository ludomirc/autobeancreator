...
(
    att_type_id INT(11) PRIMARY KEY NOT NULL,
    att_name VARCHAR(255) NOT NULL
);
CREATE TABLE bean
(
    bean_id INT(11) PRIMARY KEY NOT NULL,
...
(
    bean_att_id INT(11) PRIMARY KEY NOT NULL,
...
(
    bl_id INT(11) PRIMARY KEY NOT NULL,
